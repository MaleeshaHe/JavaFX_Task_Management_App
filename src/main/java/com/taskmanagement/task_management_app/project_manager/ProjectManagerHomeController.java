...
public class ProjectManagerHomeController implements Initializable {
    ...
    public void btnEditUser(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("project-manager-update.fxml"));
    ...
    public void btnHome(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("project-manager-home.fxml"));
        root = loader.load();
